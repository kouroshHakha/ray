...
from ray.rllib.algorithms.dqn.r2d2_tf_policy import get_distribution_inputs_and_class
...
R2D2TorchPolicy = build_policy_class(
    ...
    framework="torch",
    loss_fn=r2d2_loss,
    get_default_config=lambda: ray.rllib.algorithms.dqn.r2d2.R2D2_DEFAULT_CONFIG,
