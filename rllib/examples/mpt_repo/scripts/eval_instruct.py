...
def main(args: Namespace) -> None:
    ...
    model.eval()
    print(f"Loading done in {time.time() - s} seconds.")
    ...
    for temp, topp, topk, repp, nrnz, seed in itertools.product(
        ...
        # Convert tasks to insturctions
        batches = [[format_instruction(prompt) for prompt in batch] for batch in batches]
